...
def process_template_normal(template_file):
    global stop
    
    confidence_threshold = 8
    # Load the target image
    target = cv2.imread('screenshot_scan_test.png', 0)
...
def process_template_down(template_file):
    global stop
...
process_template_normal('C:\GitHub\ep-auto\error_windows\Web capture_4-8-2023_221021_app.educationperfect.com.jpeg')
end_time_cpu = time.time()
start_time_gpu = time.time()
process_template_down('C:\GitHub\ep-auto\error_windows\Web capture_4-8-2023_221021_app.educationperfect.com.jpeg')
...
print(f"GPU Execution Time: {execution_time_gpu:.4f} seconds")